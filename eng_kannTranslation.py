...
eng_vocabulary_size = source_vectorization.vocabulary_size()
kannda_vocabulary_size =target_vectorization.vocabulary_size()

print ('englesh :' + str(source_vectorization.vocabulary_size()))
print ('kannada :' + str( target_vectorization.vocabulary_size()))
...
decoder_outputs = layers.Dense(kannda_vocabulary_size, activation="softmax")(x)

transformer = keras.Model([encoder_inputs, decoder_inputs], decoder_outputs)
transformer.compile( optimizer="rmsprop", loss="sparse_categorical_crossentropy", metrics=["accuracy"])

callbacks = [ keras.callbacks.ModelCheckpoint("transformer_en_Kn_Trns_30.keras", save_best_only=True)]
